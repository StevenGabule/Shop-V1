...
//         echo $sql;
    ...
    public function send_mail() {
        ...
        $mail->Host = "mail.onlineshop.com"; // SMTP server
        ...
        $mail->Username = "onlineshop.abdullah@gmail.com";  // GMAIL username
        $mail->Password = "onlineshopabdullah";            // GMAIL password

        $mail->SetFrom('abdullah@onlinehop.com', 'Abdullah');

        $mail->AddReplyTo("Abdullah@onlineshop.com", "Abdullah");
        ...
        $address = "abdullahazmat180@gmail.com";
        $mail->AddAddress($address, "abdullah");
